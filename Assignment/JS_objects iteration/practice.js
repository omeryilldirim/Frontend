...
const carsSilver = carData.filter(car => car.color ==="Silver")

console.log("Silver cars", carsSilver);

// 2- 2015 yılından sonra üretilmiş arabaları bir listeye ata.

const carsAfter2015 = carData.filter(car => car.year >= 2015)

console.log("carsAfter2015", carsAfter2015);

// 3- Arabaların ortalama kilometre değerini hesapla.

const avgMileage = carData.reduce((acc, car )=> acc + car.mileage, 0) / carData.length

console.log("avgMileage", avgMileage);

// 4- 8 silindirli araçları listele

const cylinders8 = carData.filter(car=>car.engine.cylinders === 8)

const a = carData

console.log("8cylinders", cylinders8);
...
console.log(check({"Java": 10, "Ruby": 80, "Python": 65}));