...
//? Bu metotlar aslinda objelerin key ve/veya value'lari bir dizi olarak dondurur.
...
developers.forEach((person) =>
  console.log(`${person[0]} dob is : ${person[1].dob}`)
);
...
const agesInc = team.map((p) => p.age + 1);
console.log(agesInc);
...
//   person.fullName = (person.name + " " + person.surname).toUpperCase()
//   person.age += 5
// }
// console.log(team);
